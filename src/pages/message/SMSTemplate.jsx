...
const SMSTemplate = () => {
    ...
    useEffect(() => {
        setTemplates([
            { id: 1, title: 'Student Admission', message: 'Hello {student_name}, Welcome to 우리 학교. Your admission number is {admission_no}.' },
            { id: 2, title: 'Fee Reminder', message: 'Dear Parent, this is a reminder regarding the pending fees for {student_name}. Please pay by {due_date}.' },
            { id: 3, title: 'Exam Schedule', message: 'The exam schedule for {class} has been released. Please check the notice board for details.' },
        ]);
    }, []);
                        ...
                        <div className="col-md-12">
                            <div className="box box-primary">
                                <div className="box-header with-border">
                                    <h3 className="box-title">SMS Template List</h3>
                                ...
                                <div className="box-body" style={{ paddingTop: '5px' }}>
                                    <div className="mailbox-messages">
                                        <div className="download_label">SMS Template List</div>
                                                    ...
                                                    <tbody>
                                                        {currentItems.map(template => (
                                                            <tr key={template.id}>
                                                                ...
                                                                <td className="mailbox-name">{template.message}</td>
                                                        ...
                                                        {currentItems.length === 0 && (
                                                            <tr>
                                                                <td colSpan="3" className="text-center" style={{ border: '0' }}>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title">{modalMode === 'add' ? 'Add SMS Template' : 'Edit SMS Template'}</h4>
                            </div>
                                ...
                                <div className="modal-body">
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            required
                                            style={{ border: '0', borderBottom: '1px solid #f4f4f4', boxShadow: 'none' }}
                                        />
                                    </div>
                                    <div className="form-group">
