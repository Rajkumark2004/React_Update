...
const SMSTemplate = () => {
    ...
    useEffect(() => {
        ...
        setTemplates([
            { id: 1, title: 'Reminder SMS', message: 'Please check your pending fees.' },
            { id: 2, title: 'Holiday Notice', message: 'School will remain closed tomorrow due to holiday.' }
        ]);
    }, []);
    ...
    const sidebarLinks = [
        ...
        { icon: 'fa fa-file-o', label: 'SMS Template', path: '/admin/mailsms/sms_template', active: true }
    ];
                    ...
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title">Add SMS Template</h4>
                            </div>
                    ...
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title">Edit SMS Template</h4>
                            </div>
