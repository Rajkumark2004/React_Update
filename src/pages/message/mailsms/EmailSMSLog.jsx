...
const EmailSMSLog = () => {
    ...
    useEffect(() => {
        ...
        setMessages([
            { id: 1, title: 'Fee Reminder', message: 'Please pay your fees by end of month', created_at: '2026-02-01 10:00:00', send_mail: true, send_sms: false, is_group: true, is_individual: false, is_class: false },
            { id: 2, title: 'Welcome Message', message: 'Welcome to our school', created_at: '2026-02-02 11:30:00', send_mail: true, send_sms: true, is_group: false, is_individual: true, is_class: false },
            { id: 3, title: 'Class Notice', message: 'Tomorrow is a holiday', created_at: '2026-02-03 09:00:00', send_mail: false, send_sms: true, is_group: false, is_individual: false, is_class: true }
        ]);
    }, []);
    ...
    const sidebarLinks = [
        ...
        { icon: 'fa fa-list', label: 'Email/SMS Log', path: '/admin/mailsms', active: true },
