...
const StudentView = () => {
                ...
                const flattenedFees = rawFees.reduce((acc, group) => {
                    if (group.fees && Array.isArray(group.fees)) {
                        const processedFees = group.fees.map(fee => {
                            ...
                            const latestPayment = paymentDetails.length > 0 ? paymentDetails[paymentDetails.length - 1] : {};
    ...
    const handleTimelineSubmit = async (e) => {
        ...
        formData.append('timeline_date', timelineFormData.date);
        formData.append('timeline_desc', timelineFormData.description);
        formData.append('visible_check', timelineFormData.visible_check ? 'yes' : 'no');
        ...
        try {
            ...
            alert(error.message || 'Failed to add timeline');
        }
    };
    ...
    const handleDeleteTimeline = async (timelineId) => {
        if (window.confirm('Are you sure you want to delete this timeline?')) {
            try {
                ...
                alert(error.message || 'Failed to delete timeline');
            }
        }
    };
    ...
    const handleDeleteDocument = async (docId) => {
        if (window.confirm('Are you sure you want to delete this document?')) {
            try {
                ...
                // alert('Document deleted successfully'); // API returns plain text often?
                loadStudentData(id);
            } catch (error) {
            ...
            <div className="wrapper theme-white-skin">
                ...
                <div className="content-wrapper" style={{ minHeight: '828px' }}>
                    <section className="content">
                        ...
                        <Link to="/student/search" className="btn btn-primary" style={{ marginLeft: '20px' }}>
        ...
        <div className="wrapper theme-white-skin">
                ...
                <section className="content">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            {/* Profile Card */}
                            <div className="box box-primary" style={isDisabled ? { backgroundColor: '#f0dddd' } : {}}>
                                <div className="box box-widget widget-user-2 mb0">
                                    <div className="widget-user-header bg-gray-light overflow-hidden">
                                        ...
                                        <h5 className="widget-user-desc mb5">
                                            Admission No <span className="text-aqua">{student.admission_no}</span>
                                        </h5>
                                        <h5 className="widget-user-desc">
                                            Roll Number <span className="text-aqua">{student.roll_no}</span>
                                        </h5>
                                    </div>
                                </div>
                                ...
                                <div className="box-body box-profile pt0">
                                    <ul className="list-group list-group-unbordered">
                                        {isDisabled && (
                                            <>
                                                <li className="list-group-item listnoback">
                                                    <b>Disable Reason</b>
                                                    <span className="pull-right text-aqua">{student.disable_reason || '-'}</span>
                                                </li>
                                                <li className="list-group-item listnoback">
                                                    <b>Disable Note</b>
                                                    <span className="pull-right text-aqua">{student.dis_note || '-'}</span>
                                                </li>
                                                <li className="list-group-item listnoback">
                                                    <b>Disable Date</b>
                                                    <span className="pull-right text-aqua">{student.disable_at || '-'}</span>
                                                </li>
                                            </>
                                        )}
                                        <li className="list-group-item listnoback border0">
                                            <b>Class</b>
                                            <a className="pull-right text-aqua">{student.class} ({student.section})</a>
                                        </li>
                                        <li className="list-group-item listnoback">
                                            <b>Section</b>
                                        ...
                                        <li className="list-group-item listnoback">
                                            <b>RTE</b>
                                            <a className="pull-right text-aqua">{student.rte || '-'}</a>
                                        </li>
                                        <li className="list-group-item listnoback">
                                            <b>Gender</b>
                                            <a className="pull-right text-aqua">{student.gender || '-'}</a>
                                        </li>
                                        {/* Barcode */}
                                        ...
                                        {student.total_points && (
                                            <li className="list-group-item listnoback">
                                                <b>Behaviour Score</b>
                                                <a className="pull-right text-aqua">{student.total_points}</a>
                                            </li>
                                        )}
                                    </ul>
                                </div>
                            ...
                            {student.siblings && student.siblings.length > 0 && (
                                <div className="box box-primary">
                                    ...
                                    {student.siblings.map((sibling, index) => (
                                        <div className="box-widget widget-user-2" key={index}>
                                            <div className="widget-user-header bg-gray-light overflow-hidden">
                                                <div className="widget-user-image">
                                                    <img
                                                        className="profile-user-img img-responsive img-rounded"
                                                ...
                                                <h5 className="widget-user-desc mb5">
                                                    Admission No <span className="text-aqua">{sibling.admission_no}</span>
                                                </h5>
                                                <h5 className="widget-user-desc">
                                                    Roll Number <span className="text-aqua">{sibling.roll_no}</span>
                                                </h5>
                                            </div>
                                                ...
                                                <div className="no-padding">
                                                    <ul className="list-group list-group-unbordered">
                                                        <li className="list-group-item">
                                                            <b>Class</b> <a className="pull-right text-aqua">{sibling.class}</a>
                                                        </li>
                                                        <li className="list-group-item">
                                                            <b>Section</b> <a className="pull-right text-aqua">{sibling.section}</a>
                                                        </li>
                                                        <li className="list-group-item listnoback">
                                                            <b>Gender</b> <a className="pull-right text-aqua">{sibling.gender}</a>
                                                        </li>
                                                        {sibling.rte && (
                                                            <li className="list-group-item listnoback">
                                                                <b>RTE</b> <a className="pull-right text-aqua">{sibling.rte}</a>
                                                            </li>
                                                        )}
                            ...
                            <div className="nav-tabs-custom theme-shadow">
                                <ul className="nav nav-tabs">
                                    <li className={activeTab === 'activity' ? 'active' : ''}>
                                        <a href="#activity" data-toggle="tab" onClick={() => setActiveTab('activity')}>Profile</a>
                                    </li>
                                    <li className={activeTab === 'fee' ? 'active' : ''}>
                                        <a href="#fee" data-toggle="tab" onClick={() => setActiveTab('fee')}>Fees</a>
                                    </li>
                                    <li className={activeTab === 'cbseexam' ? 'active' : ''}>
                                        <a href="#cbseexam" data-toggle="tab" onClick={() => setActiveTab('cbseexam')}>CBSE Exam</a>
                                    </li>

                                    <li className={activeTab === 'attendance' ? 'active' : ''}>
                                        <a href="#attendance" data-toggle="tab" onClick={() => setActiveTab('attendance')}>Attendance</a>
                                    </li>
                                    <li className={activeTab === 'documents' ? 'active' : ''}>
                                        <a href="#documents" data-toggle="tab" onClick={() => setActiveTab('documents')}>Documents</a>
                                    </li>
                                    <li className={activeTab === 'timelineh' ? 'active' : ''}>
                                        <a href="#timelineh" data-toggle="tab" onClick={() => setActiveTab('timelineh')}>Timeline</a>
                                    </li>
                                    <li className={activeTab === 'behavioural_note' ? 'active' : ''}>
                                        <a href="#behavioural_note" data-toggle="tab" onClick={() => setActiveTab('behavioural_note')}>Behavioural Note</a>
                                    </li>
                                    ...
                                    {!isDisabled && (
                                        <>
                                            ...
                                            <li className="pull-right">
                                                <a href="#" className="text-green" data-toggle="tooltip" title="Login Details" onClick={(e) => { e.preventDefault(); setCredentialsModalOpen(true); }}>
                                                    <i className="fa fa-key"></i>
                                                </a>
                                            </li>
                                            <li className="pull-right">
                                                <a href="#" data-toggle="tooltip" title="Collect Fees">
                                                    <b>₹</b>
                                                </a>
                                            </li>
                                            <li className="pull-right">
                                                <Link to={`/student/edit/${student.id}`} data-toggle="tooltip" title="Edit">
                                    ...
                                    {isDisabled && (
                                        <li className="pull-right">
                                            <a href="#" className="text-green" data-toggle="tooltip" title="Enable">
                                ...
                                <div className="tab-content">
                                    ...
                                    <div className={`tab-pane ${activeTab === 'activity' ? 'active' : ''}`} id="activity">
                                                ...
                                                <table className="table3 table-hover table-striped tmb0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td className="col-md-5">{student.admission_date || '-'}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Date of Birth</td>
                                                            <td>{student.dob || '-'}</td>
                                                        ...
                                                        {student.custom_fields && student.custom_fields.length > 0 && (
                                                            student.custom_fields.map((field, index) => (
                                                                <tr key={index}>
                                                                    ...
                                                                    <td>
                                                                        {field.type === 'link' ? (
                                                                            <a href={field.field_value} target="_blank" rel="noopener noreferrer">
                                                                                {field.field_value}
                                                                            </a>
                                                ...
                                                <table className="table3 table-hover table-striped tmb0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td className="col-md-5">{student.current_address || '-'}</td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <table className="table3 table-hover table-striped tmb0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="col-md-5">{student.father_name || '-'}</td>
                                                            <td rowSpan="3">
                                                                <img
                                                                    className="profile-user-img img-responsive img-rounded"
                                        ...
                                        <div className="tshadow mb25 bozero">
                                            <h3 className="pagetitleh2">Route Details</h3>
                                            <div className="table-responsive around10 pt0">
                                                <table className="table3 table-hover table-striped tmb0">
                                                    <tbody>
                                                        <tr>
                                                            <td width="35%">Pick Up Point</td>
                                                            <td className="col-md-5">{student.pickup_point_name || '-'}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Route</td>
                                                ...
                                                <table className="table3 table-hover table-striped tmb0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td className="col-md-5">{student.blood_group || '-'}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>House</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{student.measurement_date && student.measurement_date !== '0000-00-00' ? student.measurement_date : '-'}</td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    {/* Fees Tab */}
                                    <div className={`tab-pane ${activeTab === 'fee' ? 'active' : ''}`} id="fee">
                                        <table className="table table-striped table-bordered table-hover example">
                                            ...
                                            <tbody>
                                                {fees.length === 0 ? (
                                                    <tr>
                                                        <td colSpan="12" className="text-danger text-center">No Fees Found</td>
                                                    </tr>
                                                ) : (
                                                    fees.map((fee, index) => (
                                                        <tr key={index}>
                                                            ...
                                                            <td>{fee.due_date || '-'}</td>
                                                            <td>
                                                                <span className={`label ${fee.status === 'Paid' ? 'label-success' : 'label-danger'}`}>{fee.status}</span>
                                                            </td>
                                                            <td>{fee.amount}</td>
                                    ...
                                    {/* CBSE Exam Tab */}
                                    <div className={`tab-pane ${activeTab === 'cbseexam' ? 'active' : ''}`} id="cbseexam">
                                        <table className="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                {cbseExams.length === 0 ? (
                                                    <tr>
                                                        <td colSpan="4" className="text-danger text-center">No CBSE Exam Result Found</td>
                                                    </tr>
                                                ) : (
                                    ...
                                    <div className={`tab-pane ${activeTab === 'attendance' ? 'active' : ''}`} id="attendance">
                                        ...
                                        <div className="row">
                                            <div className="col-md-12">
                                                <AttendanceGrid attendanceResult={attendanceResult} year={new Date().getFullYear()} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className={`tab-pane ${activeTab === 'documents' ? 'active' : ''}`} id="documents">
                                        <div className="timeline-header no-border">
                                            <button type="button" className="btn btn-xs btn-primary pull-right" onClick={handleUploadDocument}>
                                                <i className="fa fa-upload"></i> Upload Documents
                                            </button>
                                            <div className="table-responsive" style={{ clear: 'both' }}>
                                                <table className="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>Title</th>
                                                            <th>File Name</th>
                                                            <th className="mailbox-date text-right">Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {documents.length === 0 ? (
                                                            ...
                                                            documents.map((doc, idx) => (
                                                                <tr key={idx}>
                                                                    ...
                                                                    <td className="text-right">
                                                                        <a href={`https://newlayout.wisibles.com/uploads/student_documents/${student.id}/${doc.doc}`} download className="btn btn-default btn-xs" data-toggle="tooltip" title="Download">
                                                                            <i className="fa fa-download"></i>
                                                                        </a>
                                                                        <button className="btn btn-default btn-xs" data-toggle="tooltip" title="Delete" onClick={() => handleDeleteDocument(doc.id)} style={{ marginLeft: '5px' }}>
                                    ...
                                    {/* Timeline Tab */}
                                    <div className={`tab-pane ${activeTab === 'timelineh' ? 'active' : ''}`} id="timelineh">
                                        <div>
                                            <button type="button" className="btn btn-sm btn-primary pull-right" onClick={handleAddTimeline}>
                                                                    ...
                                                                    <div className="timeline-item">
                                                                        ...
                                                                        <h3 className="timeline-header">
                                                                            ...
                                                                            <div className="pull-right">
                                                                                <button className="btn btn-default btn-xs" data-toggle="tooltip" title="Delete" onClick={() => handleDeleteTimeline(item.id)}>
                                    ...
                                    <div className={`tab-pane ${activeTab === 'behavioural_note' ? 'active' : ''}`} id="behavioural_note">
                                        <div className="timeline-header no-border">
                                        ...
                                        <div className="col-lg-12 col-md-12 col-sm-12 paddlr">
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        <label>Reason <small className="req">*</small></label>
                                                        <select
                                                            className="form-control"
                                                            name="reason"
                                                            value={disableFormData.reason}
                                                            onChange={(e) => setDisableFormData({ ...disableFormData, reason: e.target.value })}
                                                        >
                                                ...
                                                <div className="col-sm-12">
                                                    <div className="form-group">
                                                        ...
                                                        <textarea
                                                            ...
                                                            onChange={(e) => setDisableFormData({ ...disableFormData, note: e.target.value })}
                                                        ></textarea>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="modal-content modal-media-content">
                            ...
                            <div className="modal-body">
                                <h4 className="text-center" style={{ marginBottom: '20px' }}>
                                    <strong>{student.firstname} {student.middlename || ''} {student.lastname || ''}</strong>
                                </h4>

                                <div className="alert alert-info text-center" style={{ marginBottom: '20px' }}>
                                    <strong>Login URL:</strong>{' '}
                                    <a href="https://newlayout.wisibles.com/site/userlogin" target="_blank" rel="noopener noreferrer">
                                        https://newlayout.wisibles.com/site/userlogin
                                    </a>
                                </div>
                                ...
                                <table className="table table-bordered">
                                    <thead>
                                        <tr className="active">
                                            <th colSpan="2" className="text-center">Student Login Credentials</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                ...
                                <table className="table table-bordered" style={{ marginTop: '15px' }}>
                                    <thead>
                                        <tr className="active">
                                            <th colSpan="2" className="text-center">Guardian Login Credentials</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
            ...
            {timelineModalOpen && (
                <div className="modal show" style={{ display: 'block', paddingRight: '15px' }}>
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <button type="button" className="close" onClick={() => setTimelineModalOpen(false)}>&times;</button>
                            ...
                            <form onSubmit={handleTimelineSubmit}>
                                <div className="modal-body">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" required value={timelineFormData.title} onChange={e => setTimelineFormData({ ...timelineFormData, title: e.target.value })} />
                                    </div>
                                    <div className="form-group">
                                        <label>Date <small className="req">*</small></label>
                                        <input type="text" className="form-control" required value={timelineFormData.date} onChange={e => setTimelineFormData({ ...timelineFormData, date: e.target.value })} />
                                    </div>
                                    <div className="form-group">
                                        <label>Description</label>
                                        <textarea className="form-control" value={timelineFormData.description} onChange={e => setTimelineFormData({ ...timelineFormData, description: e.target.value })}></textarea>
                                    </div>
                                    <div className="form-group">
                                        <label>Attach Document</label>
                                        <input type="file" className="form-control" onChange={e => setTimelineFormData({ ...timelineFormData, file: e.target.files[0] })} />
                                    </div>
                                    <div className="form-group">
                                        <label>Visible to this person</label>
                                        <div className="checkbox">
                                            <label>
                                                <input type="checkbox" checked={timelineFormData.visible_check} onChange={e => setTimelineFormData({ ...timelineFormData, visible_check: e.target.checked })} />
                                            </label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="modal-backdrop fade in" style={{ zIndex: -1 }} onClick={() => setTimelineModalOpen(false)}></div>
                </div>
            )}
            ...
            {docModalOpen && (
                <div className="modal show" style={{ display: 'block', paddingRight: '15px' }}>
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <button type="button" className="close" onClick={() => setDocModalOpen(false)}>&times;</button>
                            ...
                            <form onSubmit={handleDocumentSubmit}>
                                <div className="modal-body">
                                    <div className="form-group">
                                        <label>Title <small className="req">*</small></label>
                                        <input type="text" className="form-control" required value={docFormData.first_title} onChange={e => setDocFormData({ ...docFormData, first_title: e.target.value })} />
                                    </div>
                                    <div className="form-group">
                                        <label>Document <small className="req">*</small></label>
                                        <input type="file" className="form-control" required onChange={e => setDocFormData({ ...docFormData, first_doc: e.target.files[0] })} />
                                    </div>
                                </div>
                                <div className="modal-footer">
                                    <button type="submit" className="btn btn-info pull-right">Save</button>
                    ...
                    <div className="modal-backdrop fade in" style={{ zIndex: -1 }} onClick={() => setDocModalOpen(false)}></div>
                </div>
            )}
