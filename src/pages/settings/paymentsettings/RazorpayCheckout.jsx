                    ...
                    <div className="paddtop20" style={{ paddingTop: '20px' }}>
                        ...
                        <div className="col-md-8 offset-md-2 text-center" style={{ marginTop: '20px' }}>
                            ...
                            <div style={{ marginBottom: '10px' }}>
                                <img src="https://newlayout.wisibles.com//backend/images/razorpay.jpg?1770874763" alt="Razorpay" style={{ maxWidth: '180px' }} />
                            </div>
                            <a href="https://www.razorpay.com" target="_blank" rel="noopener noreferrer" style={{ color: '#0084B4', fontSize: '13px', textDecoration: 'none' }}>
