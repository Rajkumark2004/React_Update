                ...
                <div class="box border0">
                    ...
                    <ul class="tablists">
                        ...
                        <li class="<?php echo set_Submenu('content/studymaterial'); ?>">
                            <a class="<?php echo set_Submenu('content/studymaterial'); ?>" href="<?php echo base_url(); ?>admin/content/weeklyschedule"><img src="<?php echo base_url(); ?>/backend/images/sidebar/submenu/download_center/3.png" alt="icon3" class="img-fluid" style="width:20px"> <?php echo "Weekly Schedule"; ?></a>
                        </li> 
                        ...
                        <li class="<?php echo set_Submenu('content/worksheets'); ?>">
                            <a class="<?php echo set_Submenu('content/worksheets'); ?>" href="<?php echo base_url(); ?>admin/content/worksheets"><img src="<?php echo base_url(); ?>/backend/images/sidebar/submenu/download_center/1.png" alt="icon1" class="img-fluid" style="width:20px"> <?php echo "Worksheets"; ?></a>
                        </li>
