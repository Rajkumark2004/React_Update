...
const Other = () => {
    ...
    // Mock data based on other.php structure
    const [list, setList] = useState([
        {
            id: 1,
            title: 'Academic Year Plan 2024-25',
            type: 'Year Plans',
            date: '2024-03-01',
            is_public: 'Yes',
            class: 'All Classes',
            section: '',
            file: '#',
            note: 'Comprehensive year plan'
        },
        {
            id: 2,
            title: 'Sports Year Plan',
            type: 'Year Plans',
            date: '2024-03-05',
            is_public: 'No',
            class: 'Class 9',
            section: 'A',
            file: '#',
            note: 'Sports activities schedule'
        }
    ]);
    ...
    return (
        <div className="wrapper">
            ...
            <Sidebar sessionYear={sessionYear} currentUrl="/admin/content/other" />
                        ...
                        <div className="col-md-9">
                            <div className="box box-primary" id="other_download">
                                <div className="box-header ptbnull">
                                    <h3 className="box-title titlefix">Year Plans</h3>
                                ...
                                <div className="box-body">
                                    ...
                                    <div className="mailbox-messages table-responsive">
                                        <div className="download_label">Year Plans</div>
                                                ...
                                                {list.length === 0 ? (
                                                    ...
                                                    list.map((data) => (
                                                        <tr key={data.id}>
                                                            ...
                                                            <td className="mailbox-name">
                                                                {data.is_public === "Yes" ? "ALL Classes" : `${data.class} (${data.section})`}
                                                            </td>
