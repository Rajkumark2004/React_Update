...
const Syllabus = () => {
    ...
    // Mock data based on syllabus.php structure
    const [list, setList] = useState([
        {
            id: 1,
            title: 'Annual Syllabus 2024-25',
            type: 'Syllabus',
            date: '2024-03-01',
            is_public: 'Yes',
            class: 'All Classes',
            file: '#',
            note: 'Complete syllabus for the academic year'
        },
        {
            id: 2,
    ...
    return (
        <div className="wrapper">
            ...
            <Sidebar sessionYear={sessionYear} currentUrl="/admin/content/syllabus" />
                ...
                <section className="content">
                    <div className="row">
                        ...
                        <div className="col-md-9">
                            <div className="box box-primary" id="syllabus">
                                <div className="box-header ptbnull">
                                    <h3 className="box-title titlefix">Syllabus</h3>
                                ...
                                <div className="box-body">
                                    ...
                                    <div className="mailbox-messages table-responsive">
                                        <div className="download_label">Syllabus</div>
